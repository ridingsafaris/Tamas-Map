    ...
    rides.forEach(ride => {
     let feature = {
      ...
      "properties": {
        ...
        "price_per_night_formatted": ride.duration === null || isNaN(ride.duration) ? ride.price.toLocaleString("en-US") : parseInt(ride.price / ride.duration).toLocaleString("en-US"),
        "currency": ride.currency,
        "riding_level": ride.riding_level,
        "months": ride.months,
        "category": ride.black_saddle ? [...ride.category, "Black Saddle"] : ride.category,
        "price": isNaN(ride.duration) ? 0 : ride.price,
        "price_formatted": isNaN(ride.duration) ? 0 : ride.price.toLocaleString("en-US"),
        "name": ride.itinerary,
        "title": ride.title,
