...
const ThreeWayToggle = ({ options = [], value = null, onChange }) => {
    ...
    return (
        <div className="w-full justify-center items-center">
          ...
          {options.map((option, idx) => (
            <div key={option} className="w-1/3 flex items-center">
              <button
                className={`w-full tracking-wide font-semibold px-4 py-2 text-xs cursor-pointer text-center text-gray-700 ${
                  value === option
